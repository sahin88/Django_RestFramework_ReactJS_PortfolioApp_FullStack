...
function Element(_ref) {
  var _ref$attributes = _ref.attributes,
      ...
      Tag = _ref.tagName;
  return selfClose ? React__default['default'].createElement(Tag, attributes) : React__default['default'].createElement(Tag, attributes, children);
}
      ...
      if (node.nodeType === ELEMENT_NODE) {
        ...
        if (transform) {
          ...
          if (transformed === null) {
            ...
            content.push(React__default['default'].cloneElement(transformed, {
              key: _key
            }));
            return;
          }
        ...
        if (!(noHtml || noHtmlExceptMatchers && tagName !== 'br') && _this3.isTagAllowed(tagName) && (allowElements || _this3.canRenderChild(parentConfig, config))) {
          ...
          content.push(React__default['default'].createElement(Element, _extends({}, elementProps, {
            key: _this3.keyIndex
          }), children || _this3.parseNode(nextNode, config)));
        } else {
...
function Markup(props) {
  ...
  if (noWrap) {
    return React__default['default'].createElement(React__default['default'].Fragment, null, mainContent);
  }
...
function Interweave(props) {
  ...
  return React__default['default'].createElement(Markup, {
    attributes: attributes,
    containerTagName: props.containerTagName,
...
var Matcher = function () {
  ...
  _proto.createElement = function createElement(children, props) {
    ...
    if (this.factory) {
      element = React__default['default'].createElement(this.factory, props, children);
    } else {
      element = this.replaceWith(children, props);
    }

    if ("production" !== process.env.NODE_ENV) {
      if (typeof element !== 'string' && !React__default['default'].isValidElement(element)) {
